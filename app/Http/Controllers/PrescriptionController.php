...
class PrescriptionController extends Controller{
    ...
    if(isset($request->test_name)):
		...
		return Redirect::route('prescription.all')->with('success', __('Prescription Created Successfully!'));
    ...
    public function all(){
        ...
        if(Auth::user()->role == 'patient'){
            $prescriptions = Prescription::where('user_id', Auth()->id())->orderBy('id','DESC')->paginate(get_option('pagination'));
        }else{
            $prescriptions = Prescription::orderBy('id','DESC')->paginate(get_option('pagination'));
        }
    ...
    public function view($id){
        ...
        if(Auth::user()->role == 'patient'){
            $prescription = Prescription::where('id',$id)->where('user_id', Auth()->id())->first();
            if(!$prescription): abort(404); endif;
        }else{
    ...
    public function update(Request $request){
        ...
        return Redirect::route('prescription.view',['id' => $request->prescription_id])->with('success', __('Prescription Edited Successfully!'));
    ...
    public function destroy($id){
        ...
        return Redirect::route('prescription.all')->with('success', __('Prescription Deleted Successfully!'));
