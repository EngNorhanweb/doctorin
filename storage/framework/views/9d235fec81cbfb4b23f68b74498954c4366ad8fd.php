                        ...
                        <div class="col-lg-12">
                           <div class="p-5">
                              <div class="text-center">
                                 <img src="<?php echo e(asset('img/logo-dark.svg')); ?>" class="img-fluid" >
                                 <hr>
                                 <h4 class="h5 text-gray-700 mb-4"><?php echo e(__('Welcome')); ?></h4> <?php echo e(session('purchase_code')); ?>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus  aria-describedby="emailHelp" placeholder="<?php echo e(__('Email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <button class="btn btn-doctorino btn-user btn-block" type="submit"> <?php echo e(__('Login')); ?></button> 
                              </form>
                              <hr>
...
</html><?php /**PATH E:\doctorino-520\codecanyon-28707541-doctorino-doctor-chamber-management-system\v5.2.0\v5.2.0\resources\views/auth/login.blade.php ENDPATH**/ ?>