					...
					<footer class="sticky-footer bg-white">
						<div class="container my-auto">
							<div class="copyright my-auto">
								...
								<span style="float: right;">Version 5.0</span>
							</div>
						</div>
					</footer>
					<!-- End of Footer -->
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/doctorino/v5.0/resources/views/layouts/staff_layout.blade.php ENDPATH**/ ?>