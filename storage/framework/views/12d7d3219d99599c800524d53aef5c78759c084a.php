   ...
   <div class="col-md-10">
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('New Patient')); ?></h6>
         </div>
         <div class="card-body">
            <form method="post" action="<?php echo e(route('patient.create')); ?>" enctype="multipart/form-data">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                     <label for="inputAddress"><?php echo e(__('Birth Date')); ?><font color="red">*</font></label>
               ...
               <div class="form-row">
                  <div class="form-group col-md-6">
                     <label for="inputCity"><?php echo e(__('Gender')); ?><font color="red">*</font></label>
                  ...
                  <div class="form-group col-md-6">
                     <label for="inputZip"><?php echo e(__('Blood Group')); ?></label>
                     <select class="form-control" name="blood" id="Blood">
                        <option value="Unknown"><?php echo e(__('Unknown')); ?></option>
               ...
               <div class="form-row">
                  <div class="form-group col-md-6">
                     ...
                     <i class="fa fa-cloud-upload"></i> <?php echo e(__('Select Image to Upload')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.'.Auth::user()->role.'_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/doctorino/v5.2.0/resources/views/patient/create.blade.php ENDPATH**/ ?>