        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item <?php echo e(isActive('LaravelInstaller::licenseForm')); ?>">
                        <?php if(Request::is('install/digit94team/license') ): ?>
                            <a href="<?php echo e(route('LaravelInstaller::licenseForm')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/doctorino/v5.2.0/resources/views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>