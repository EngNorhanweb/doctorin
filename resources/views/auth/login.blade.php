                        ...
                        <div class="col-lg-12">
                           <div class="p-5">
                              <div class="text-center">
                                 <img src="{{ asset('img/logo-dark.svg') }}" class="img-fluid" >
                                 <hr>
                                 <h4 class="h5 text-gray-700 mb-4">{{ __('Welcome') }}</h4> {{ session('purchase_code') }}
                              </div>
                              <form method="POST" action="{{ route('login') }}" class="user">
                                 ...
                                 <button class="btn btn-doctorino btn-user btn-block" type="submit"> {{ __('Login') }}</button> 
                              </form>
                              <hr>
