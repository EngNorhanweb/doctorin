         ...
         <div class="card-body">
            <form method="post" action="{{ route('notifications_settings.store') }}">
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="NEXMO_KEY" name="NEXMO_KEY" value="{{ get_option('NEXMO_KEY') }}">
                     {{ csrf_field() }}
                  </div>
               </div>
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="NEXMO_SECRET" name="NEXMO_SECRET" value="{{ get_option('NEXMO_SECRET') }}">
                  </div>
               </div>
         </div>
      </div>
      ...
      <div class="card shadow mb-4">
         ...
         <div class="card-body">
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="TWILIO_AUTH_SID" name="TWILIO_AUTH_SID" value="{{ get_option('TWILIO_AUTH_SID') }}">
                     {{ csrf_field() }}
                  </div>
               </div>
               <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="TWILIO_AUTH_TOKEN" name="TWILIO_AUTH_TOKEN" value="{{ get_option('TWILIO_AUTH_TOKEN') }}">
                  </div>
               </div>
               <div class="form-group row">
                  <label for="TWILIO_WHATSAPP_FROM" class="col-sm-4 col-form-label">{{ __('TWILIO WHATSAPP FROM') }}</label>
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="TWILIO_WHATSAPP_FROM" name="TWILIO_WHATSAPP_FROM" value="{{ get_option('TWILIO_WHATSAPP_FROM') }}">
                  </div>
               </div>
