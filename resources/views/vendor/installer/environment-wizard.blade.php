        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Doctorino" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="block margin-bottom-2">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_secret') ? ' has-error ' : '' }}">
                            ...
                            @endif
                            <input type="hidden" name="purchase_code" value="{{ session('purchase_code') }}"/>
