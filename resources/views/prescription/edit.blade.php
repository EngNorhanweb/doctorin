      ...
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="{{ __('Edit Prescription') }}" class="btn btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="card-body">
               <fieldset class="drugs_labels">
                    ...
                    @foreach($prescription_drugs as $prescription_drug)
                         <section class="field-group">
                             <div class="row">
                                 <div class="col-md-2">
                                     <div class="form-group-custom">
                                         <input type="text" class="form-control" name="type[]" id="task_{?}" placeholder="{{ __('Type') }}" class="ui-autocomplete-input" autocomplete="off" value="{{ $prescription_drug->type }}">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-6">
                                     <div class="form-group-custom">
                                         <input type="text" id="dose" name="dose[]" class="form-control" placeholder="{{ __('Dose') }}" value="{{ $prescription_drug->dose }}">
                                         <label class="control-label"></label><i class="bar"></i>
                                 ...
                                 <div class="col-md-6">
                                     <div class="form-group-custom">
                                         <input type="text" id="duration" name="duration[]" class="form-control" placeholder="{{ __('Duration') }}" value="{{ $prescription_drug->duration }}">
                                     </div>
                                 </div>
                             </div>
                             <div class="row">
                                 <div class="col-md-9">
                                     <div class="form-group-custom">
                                         <input type="text" id="drug_advice" name="drug_advice[]" class="form-control" placeholder="{{ __('Advice_Comment') }}" value="{{ $prescription_drug->drug_advice }}">
                                     </div>
                                 </div>
                                  <div class="col-md-3">
                                        <a type="button" class="btn btn-danger btn-sm text-white span-2 delete"><i class="fa fa-trash font-size-12"></i> {{ __('Remove') }}</a>
                                   </div>
                                   <div class="col-12">
                                        <hr color="red">
                                  </div>
                ...
                @endforeach 
                  ...
                  <div class="form-group">
                     <a type="button" class="btn btn-sm btn-primary add text-white" align="center"><i class='fa fa-plus'></i> {{ __('Add Drug') }}</a>
                  </div>
               </fieldset>
            </div>
         </div>
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <fieldset class="test_labels">
                  <div class="repeatable">
                      @foreach($prescription_tests as $prescription_test)
                            <div class="field-group row">
                             ...
                             <div class="col-md-3">
                                 <a type="button" class="btn btn-danger delete text-white btn-sm" align="center"><i class="fa fa-trash font-size-12"></i> {{ __('Remove') }}</a>
                  ...
                  <div class="form-group">
                     <a type="button" class="btn btn-sm btn-primary add text-white" align="center"><i class='fa fa-plus'></i> {{ __('Add Test') }}</a>
                  </div>
               </fieldset>
            </div>
         </div>
