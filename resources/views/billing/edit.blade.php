      ...
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="{{ __('Update Invoice') }}" class="btn btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
                           ...
                           <div class="field-group row">
                            <div class="col">
                               <div class="form-group-custom">
                                  <input type="text" id="strength" name="invoice_title[]"  class="form-control" placeholder="{{ __('Invoice Title') }}" value="{{ $billing_item->invoice_title }}" required>
                                 <input type="hidden" name="billing_item_id[]" value="{{ $billing_item->id }}">
                               </div>
                            </div>
                            <div class="col">
                               <div class="input-group mb-3">
                                <input type="number" class="form-control" placeholder="{{ __('Amount') }}" aria-label="Amount" aria-describedby="basic-addon1" name="invoice_amount[]" value="{{ $billing_item->invoice_amount }}" required>
