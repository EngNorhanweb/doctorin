...
@section('content')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
               <div class="row">
                <div class="col-8">
                    <h6 class="m-0 font-weight-bold text-primary w-75 p-2">{{ __('All Roles') }}</h6>
                </div>
                <div class="col-4">
                  <a href="{{ route('role.create') }}" class="btn btn-primary btn-sm float-right "><i class="fa fa-plus"></i> {{ __('New Role') }}</a>
                </div>
              </div>
            </div>
            <div class="card-body">
