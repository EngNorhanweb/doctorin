   ...
   <div class="col-md-10">
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            ...
            <div class="row">
                <div class="col-8">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Patient') }}</h6>
                </div>
                <div class="col-4">
                  @can('view patient')
                  <a href="{{ route('patient.view', ['id' => $patient->id]) }}" class="btn btn-primary btn-sm float-right "><i class="fa fa-eye"></i> {{ __('View Patient') }}</a>
                  @endcan
                </div>
              </div>
         </div>
